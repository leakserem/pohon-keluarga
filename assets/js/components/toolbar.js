...
function installMobileUI() {
    ...
    const refreshBackdrop = () => {
        backdrop.classList.toggle(
            "open",
            sidebar.classList.contains("open") || detail.classList.contains("open")
        );
    };
    ...
    $("#mobileMembers")?.addEventListener("click", () => openSidebar());
    $("#mobileAdd")?.addEventListener("click", () => Dialog.openAddMember());
    ...
    style.textContent = `
        ...
        @media (max-width: 800px) {
            ...
            #detailPanel {
                ...
                margin: 0 !important;
                padding: 26px 18px calc(20px + env(safe-area-inset-bottom)) !important;
                border: 0 !important;
